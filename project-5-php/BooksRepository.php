...
class BooksRepository
{
    ...
    //     return $row ? new Car($row['brand'], $row['model'], $row['year'], $row['reg'], $row['km'], $row['id']) : null;
    // }
    ...
    // {
    //     $stmt = $this->pdo->prepare("UPDATE cars SET brand = ?, model = ?, year = ?, reg = ?, km = ? WHERE id = ?");
    //     return $stmt->execute([$books->brand, $books->model, $books->year, $books->reg, $books->km, $books->id]);
    // }
